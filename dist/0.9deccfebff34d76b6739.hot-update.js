  ...
  function Scene(scene, name) {
    ...
    this.animations = {
      ...
      moveShapes: function moveShapes(mouseMove) {
        console.log(this);
        var shapes = this.scene.name.shapes;
        shapes.reverse();
        ...
        shapes.forEach(function (shape) {
          var projectedXY = void 0,
              ...
              newY = void 0;
          if (mouseMove) {
            projectedXY = [shape.calc3DLocation(this.scene.camera)[0] - shape.projectedXY[0], shape.calc3DLocation(this.scene.camera)[1] - shape.projectedXY[1]];
  ...
  _createClass(Name, [{
    ...
    value: function createLetters(scene) {
      ...
      letters.forEach(function (el, index) {
        ...
        for (var _i3 = 0; _i3 < letter.totalShapes; _i3++) {
          shapes.push(letter.shapes[_i3]);
        }
      });
...
var Letter = function () {
  ...
  _createClass(Letter, [{
    ...
    value: function createShapes() {
      for (var _i4 = 0; _i4 < this.totalShapes; _i4++) {
...
//# sourceMappingURL=0.9deccfebff34d76b6739.hot-update.js.map