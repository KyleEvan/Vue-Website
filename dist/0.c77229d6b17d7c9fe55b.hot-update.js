...
var _gsap = __webpack_require__(392);

var _charming = __webpack_require__(393);
...
var Scene = function () {
  ...
  function Scene(scene, name) {
    ...
    this.sceneSize = 1;
    this.sceneBounds = scene.getBoundingClientRect();
    this.sceneBounds = {
      // top: -(this.sceneSize/2)*window.innerHeight,
      // right: (this.sceneSize/2)*window.innerWidth,
      // bottom: (this.sceneSize/2)*window.innerHeight,
      // left: -(this.sceneSize/2)*window.innerWidth
      top: (this.sceneBounds.top - this.sceneBounds.bottom) / 2,
      right: this.sceneBounds.right / 2,
      bottom: this.sceneBounds.bottom / -2,
      left: (this.sceneBounds.left - this.sceneBounds.right) / 2
    };
    ...
    this.animations = {
      ...
      moveShapes: function moveShapes(shapes) {
        shapes.reverse();
      ...
      var handleMouseMove = throttle(function (e) {
        if (scene.interactive) {
          ...
          scene.name.shapes.forEach(function (shape) {
            var projectedXY = [shape.calc3DLocation(scene.camera)[0] - shape.projectedXY[0], shape.calc3DLocation(scene.camera)[1] - shape.projectedXY[1]];
            updatedShapes.push({
              target: shape.el,
...
//# sourceMappingURL=0.c77229d6b17d7c9fe55b.hot-update.js.map