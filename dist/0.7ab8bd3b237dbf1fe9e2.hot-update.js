...
var Scene = function () {
  ...
  function Scene(scene, name) {
    ...
    this.sceneSize = 1;
    this.bounds = scene.getBoundingClientRect();
    this.bounds = {
      top: this.bounds.bottom / -2,
      right: this.bounds.right / 2,
      bottom: this.bounds.bottom / 2,
      left: this.bounds.right / -2
    };
  ...
  _createClass(Shape, [{
    ...
    value: function getsetTransform(projectedXY) {
      if (!this.transforms) {
        ...
        console.log(this.relationalValues.translateX);
        console.log(this.relationalValues.translateY);
...
//# sourceMappingURL=0.7ab8bd3b237dbf1fe9e2.hot-update.js.map